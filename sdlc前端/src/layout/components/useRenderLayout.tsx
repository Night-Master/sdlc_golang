...
export const useRenderLayout = () => {
  const renderClassic = () => {
    return (
      <>
        <div  class={['absolute top-0 left-0 h-full menu-c', { '!fixed z-3000': mobile.value }]}>
          {logo.value ? (
            <Logo
              class={[
                ' border-bottom-1 border-solid border-[var(--logo-border-color)] dark:border-[var(--el-border-color)]',
                {
          ...
          <Menu class={['Menu-c',{ '!h-[calc(100%-var(--logo-height))]': logo.value }]}></Menu>
        </div>
        <div
          class={[
            `${prefixCls}-content`,
        ...
        >
          ...
          >
            <div
            style="padding:0 20px;left:0px!important;width:100%"
              class={[
                {
